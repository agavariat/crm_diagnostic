...
class CrmDiagnosticLineFinance(models.Model):
    _name = 'crm.diagnostic.line.finance'
    _description = 'Líneas de diagnostico finance'
    # _rec_name = 'area'
    ...
    def create(self, values):
        return super(CrmDiagnosticLineFinance, self).create(values)
