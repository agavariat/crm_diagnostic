...
##########################################################################
    ...
    def compute_first_module(self):
        for lead in self:
            if lead.is_facilitator() or lead.is_cordinador():
    ...
    def compute_second_module(self):
        for lead in self:
            if (lead.is_facilitator() or lead.is_cordinador()) and lead.first_module_ready:
    ...
    def compute_third_module(self):
        for lead in self:
            if (lead.is_facilitator()  or lead.is_cordinador()) and lead.second_module_read:
